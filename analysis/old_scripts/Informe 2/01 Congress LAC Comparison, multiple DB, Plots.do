/*******************************************************************************
	...
	Title:		01	Congress LAC Comparison, multiple DB, Plots
	Author:		Lucas García
	Date:		March 07, 2023
	Version:	Stata 17

	Summary:	This dofile plots Congress trust trends using 2 different data 
...
*01		Collapse Annualy
collapse (mean) d_congress , by(year chile)

*02		Post in temporal file
forvalues v = 1/12{
	post `lgc' ("Latinobarometro") (d_congress[`v']) (year[`v']) (chile[`v'])
}	
...
collapse (mean) congress, by(year chile)

*02		Post in temporal file
forvalues v = 1/10{
	post `lgc' ("LAPOP") (congress[`v']) (year[`v']) (chile[`v'])
}
...
graph export "$graphs/Congress trust, Chile y LAC, multiple DB.pdf", replace