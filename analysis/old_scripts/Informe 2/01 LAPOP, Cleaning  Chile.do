/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Chile
	Author:		Lucas García
	Date:		February 28, 2023
	Version:	Stata 17

	Summary:	This dofile cleans Chilean LAPOP survey from 2010 until 2021.
...
use "$rawdata/CHL_2021_LAPOP_AmericasBarometer_v1.2_w.dta", clear
...
use "$rawdata/Chile LAPOP AmericasBarometer 2019 v1.0_W.dta", clear
...
use "$rawdata/336280178Chile LAPOP AmericasBarometer 2017 V1.0_W.dta", clear
...
use "$rawdata/553131127Chile LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/420502678Chile LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/1217681709Chile_LAPOP_AmericasBarometer 2010 data set approved v4.dta", clear
...
*00		Append
append using `chile_2021' `chile_2019' `chile_2017' `chile_2014' `chile_2012'
...
*02		Save Database
save "$usedata/LAPOP, Chile.dta", replace