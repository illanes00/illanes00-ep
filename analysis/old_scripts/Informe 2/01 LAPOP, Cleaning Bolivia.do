/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Bolivia
	Author:		Lucas García
...
use "$rawdata/BOL_2021_LAPOP_AmericasBarometer_v1.2_w.dta", clear
...
use "$rawdata/Bolivia LAPOP AmericasBarometer 2019 v1.0_W.dta", clear
...
use "$rawdata/142790203Bolivia LAPOP AmericasBarometer 2017 V1.0_W.dta", clear
...
use "$rawdata/1140434363Bolivia LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/1852710534Bolivia LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/1748144313Bolivia_LAPOP_AmericasBarometer 2010 data set  approved v3.dta", clear
...
*00		Append
append using `bol_2021' `bol_2019' `bol_2017' `bol_2014' `bol_2012'
...
*02		Save Database
save "$usedata/LAPOP, Bolivia.dta", replace