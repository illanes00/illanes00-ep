/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Colombia
	Author:		Lucas García
	Date:		February 28, 2023
	Version:	Stata 17

	Summary:	This dofile cleans Colombia LAPOP survey from 2010 until 2021.
...
use "$rawdata/COL_2021_LAPOP_AmericasBarometer_v1.2_w.dta", clear
...
use "$rawdata/Colombia LAPOP AmericasBarometer 2018 v1.0_W.dta", clear
...
use "$rawdata/1966987763Colombia LAPOP AmericasBarometer 2016 V1.0_W.dta", clear
...
use "$rawdata/1543363879Colombia LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/1553850479Colombia LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/1827093199Colombia2010_Rev1_W.dta", clear
...
*00		Append
append using `col_2021' `col_2019' `col_2017' `col_2014' `col_2012'
...
*02		Save Database
save "$usedata/LAPOP, Colombia.dta", replace