/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Mexico
	Author:		Lucas García
	Date:		March 02, 2023
	Version:	Stata 17

	Summary:	This dofile cleans Mexico LAPOP survey from 2010 until 2021.
...
use "$rawdata/MEX_2021_LAPOP_AmericasBarometer_v1.2_w.dta", clear
...
keep pais year elections_trust institutions_respect democ_satisf police_response

*03		Save as temporal file 
tempfile mex_2021
save `mex_2021', replace
...
use "$rawdata/Mexico LAPOP AmericasBarometer 2019 v1.0_W.dta", clear
...
use "$rawdata/275973272Mexico LAPOP AmericasBarometer 2017 V1.0_W.dta", clear
...
use "$rawdata/534049480Mexico LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/641926122Mexico LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/2054050000Mexico_LAPOP_AmericasBarometer 2010 data set  approved V5.dta", clear
...
*00		Append
append using `mex_2021' `mex_2019' `mex_2017' `mex_2014' `mex_2012'
...
*02		Save Database
save "$usedata/LAPOP, Mexico.dta", replace