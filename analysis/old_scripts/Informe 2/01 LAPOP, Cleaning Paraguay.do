/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Paraguay
	Author:		Lucas García
	Date:		March 02, 2023
	Version:	Stata 17

	Summary:	This dofile cleans Paraguay LAPOP survey from 2010 until 2021.
...
use "$rawdata/PRY_2021_LAPOP_AmericasBarometer_v1.2_w.dta", clear
...
use "$rawdata/Paraguay LAPOP AmericasBarometer 2019 v1.0_W.dta", clear
...
use "$rawdata/1311870907Paraguay LAPOP AmericasBarometer 2016 V1.0 W.dta", clear
...
use "$rawdata/1820423111Paraguay LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/1346923279Paraguay LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/988869591Paraguay_LAPOP_AmericasBarometer 2010 data set approved v4.dta", clear
...
*00		Append
append using `pry_2021' `pry_2019' `pry_2017' `pry_2014' `pry_2012'
...
*02		Save Database
save "$usedata/LAPOP, Paraguay.dta", replace