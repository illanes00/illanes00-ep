/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Uruguay
	Author:		Lucas García
	Date:		March 02, 2023
	Version:	Stata 17

	Summary:	This dofile cleans Uruguay LAPOP survey from 2010 until 2021.
...
use "$rawdata/URY_2021_LAPOP_AmericasBarometer_v1.2_w.dta", clear
...
use "$rawdata/Uruguay LAPOP AmericasBarometer 2019 v1.0_W.dta", clear
...
use "$rawdata/646644681Uruguay LAPOP AmericasBarometer 2017 V1.0_W.dta", clear
...
use "$rawdata/1654049537Uruguay LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/878322670Uruguay LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/1109346770Uruguay_LAPOP_AmericasBarometer 2010 data set  APPROVED V3.dta", clear
...
*00		Append
append using `ury_2021' `ury_2019' `ury_2017' `ury_2014' `ury_2012'
...
*02		Save Database
save "$usedata/LAPOP, Uruguay.dta", replace