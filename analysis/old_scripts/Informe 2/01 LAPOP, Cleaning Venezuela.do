/*******************************************************************************
	...
	Title:		01	LAPOP, Cleaning Venezuela
	Author:		Lucas García
	Date:		March 02, 2023
	Version:	Stata 17

	Summary:	This dofile cleans Venezuela LAPOP survey from 2010 until 2021.
...
*02		Keep relevant variables	
keep pais year elections_trust institutions_respect democ_satisf FFAA congress police political_parties

*03		Save as temporal file 
tempfile ven_2019
save `ven_2019', replace
...
use "$rawdata/25258094Venezuela LAPOP AmericasBarometer 2016-17 V1.0_W.dta", clear
...
use "$rawdata/822140976Venezuela LAPOP AmericasBarometer 2014 v3.0_W.dta", clear
...
use "$rawdata/256579462Venezuela LAPOP AmericasBarometer 2012 Rev1_W.dta", clear
...
use "$rawdata/1451946926Venezuela_LAPOP_AmericasBarometer 2010 data set APPROVED v3.dta", clear
...
*00		Append
append using /*`ven_2021' `ven_2019'*/ `ven_2017' `ven_2014' `ven_2012'
...
*02		Save Database
save "$usedata/LAPOP, Venezuela.dta", replace