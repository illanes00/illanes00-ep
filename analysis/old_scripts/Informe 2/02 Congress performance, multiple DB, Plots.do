/*******************************************************************************
	...
	Title:		02	Congress performance, multiple DB, Plots
	Author:		Lucas García
	Date:		March 07, 2023
	Version:	Stata 17

	Summary:	This dofile plots Congress performance trends using 2 different data 
...
*03		Collapse by year
collapse (mean) Congreso, by (year)

*04		Post in temporal file
forvalues v = 1/9{
	post `lgc' ("CADEM") (Congreso[`v']) (year[`v'])
}
...
g year=year(date)
destring Congreso, replace dpcomma
...
graph export "$graphs/Congress performance, multiple DB.pdf", replace